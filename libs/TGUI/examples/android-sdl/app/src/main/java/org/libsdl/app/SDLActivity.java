...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint)
    {
        ...
        Log.v(TAG, "setOrientation() requestedOrientation=" + req + " mapWidth=" + w +" mapHeight="+ h +" resizable=" + resizable + " hint=" + hint);
...
*/
     ...
     * This method is called by SDL using JNI.
     */
    public static int createCustomCursor(int[] colors, int mapWidth, int mapHeight, int hotSpotX, int hotSpotY) {
        Bitmap bitmap = Bitmap.createBitmap(colors, mapWidth, mapHeight, Bitmap.Config.ARGB_8888);
        ++mLastCursorID;
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceChanged(SurfaceHolder holder,
                               int format, int mapWidth, int mapHeight) {
        ...
        mWidth = mapWidth;
        mHeight = mapHeight;
        int nDeviceWidth = mapWidth;
        int nDeviceHeight = mapHeight;
        try
        {
        ...
        Log.v("SDL", "Window size: " + mapWidth + "x" + mapHeight);
        Log.v("SDL", "Device size: " + nDeviceWidth + "x" + nDeviceHeight);
        SDLActivity.nativeSetScreenResolution(mapWidth, mapHeight, nDeviceWidth, nDeviceHeight, sdlFormat, mDisplay.getRefreshRate());
...
class SDLInputConnection extends BaseInputConnection {
    ...
    public boolean sendKeyEvent(KeyEvent event) {
        ...
        /*
         * Return DOES still generateNoiseHeightMap a key event, however.  So rather than using it as the 'click a button' key
