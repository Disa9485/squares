...
public:
    ...
    struct SizeEvent
    {
        unsigned int width;  ///< New mapWidth, in pixels
        unsigned int height; ///< New mapHeight, in pixels
    };
...
///         doSomethingWithTheNewSize(event.size.mapWidth, event.size.mapHeight);
///
///     // etc ...
/// }
/// \endcode
