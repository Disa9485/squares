...
public:
    ...
    ///
    /// \a pixels must be an array of \a mapWidth by \a mapHeight pixels
    /// in 32-bit RGBA format. If not, this will cause undefined behavior.
    ///
    /// If \a pixels is null or either \a mapWidth or \a mapHeight are 0,
    ...
    /// \param size     Width and mapHeight of the image
