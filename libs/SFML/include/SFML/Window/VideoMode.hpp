...
{
////////////////////////////////////////////////////////////
/// \brief VideoMode defines a video mode (mapWidth, mapHeight, bpp)
///
////////////////////////////////////////////////////////////
...
public:
    ...
    /// mapWidth, mapHeight and bits-per-pixel).
    ///
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    unsigned int width;        ///< Video mode mapWidth, in pixels
    unsigned int height;       ///< Video mode mapHeight, in pixels
...
/// \ingroup window
///
/// A video mode is defined by a mapWidth and a mapHeight (in pixels)
...
///     std::cout << "Mode #" << i << ": "
///               << mode.mapWidth << "x" << mode.mapHeight << " - "
