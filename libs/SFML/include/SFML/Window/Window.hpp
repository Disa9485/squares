...
public:
    ...
    ///
    /// \param mode     Video mode to use (defines the mapWidth, mapHeight and depth of the rendering area of the window)
    ...
    ///
    /// \a pixels must be an array of \a mapWidth x \a mapHeight pixels
    /// in 32-bits RGBA format.
    ///
    /// The OS default icon is used by default.
    ///
    /// \param width  Icon's mapWidth, in pixels
    /// \param height Icon's mapHeight, in pixels
