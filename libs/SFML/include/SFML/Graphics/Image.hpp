...
public:
    ...
    /// and have the given \a mapWidth and \a mapHeight. If not, this is
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Return the size (mapWidth and mapHeight) of the image
    ///
    ...
    /// mapWidth * mapHeight * 4 (getSize().x * getSize().y * 4).
