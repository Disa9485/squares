...
public:
    ...
    ///
    /// Be careful, the last two parameters are the mapWidth
    /// and mapHeight, not the right and bottom coordinates!
    ///
...
/// its member variables (left, top, mapWidth and mapHeight) are public
...
/// \li The right (left + mapWidth) and bottom (top + mapHeight) edges are excluded from the rectangle's area
///
